...
public final class carData_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write('\n');
      out.write('	');
      com.example.servletjspdemo.web.CarFormBean area = null;
      synchronized (session) {
        area = (com.example.servletjspdemo.web.CarFormBean) _jspx_page_context.getAttribute("area", PageContext.SESSION_SCOPE);
        if (area == null){
          area = new com.example.servletjspdemo.web.CarFormBean();
          _jspx_page_context.setAttribute("area", area, PageContext.SESSION_SCOPE);
        }
      }
      out.write("\n");
      out.write("\t\t\t");
      ...
      out.write("\t<fieldset>\n");
      out.write("\t\t<legend>\n");
      out.write("\t\t\t<h2>Car to add:</h2>\n");
      out.write("\t\t</legend>\n");
      out.write("\t<form action=\"addCar.jsp\" method=\"get\">\n");
      ...
      out.write("<br /> \n");
      out.write("\t\t\n");
      out.write("\t\t<!-- Wypisanie equipment z sesji -->\n");
      out.write("\t\tEquipment:\n");
      out.write("\t\t\n");
      out.write("\t\t");
      ...
      out.write("\t\n");
      out.write("\t\n");
      out.write("\t\t<!-- Wypisanie zinterpretowanego capacity z sesji -->\n");
      out.write("\t\t<br /> Capacity:\n");
      out.write("\t\t");
      ...
      out.write("\t\t\n");
      out.write("\n");
      out.write("\t\t<!-- Wypisanie tekst area z sesji -->\n");
      out.write("\t\t<br/>\n");
      ...
      out.write("\t\t</form>\n");
      out.write("\t\t<a href=\"change.jsp\">\n");
      out.write("\t\t\t<font size=\"4\" color=\"blue\">edit</font>\n");
      out.write("\t\t</a>\n");
      out.write("\t</fieldset>\n");
      out.write("\t<footer>\n");
      out.write("\t<center>\n");
